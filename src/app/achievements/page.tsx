    ...
    >
      ...
      <section className="relative pt-28 pb-10 md:pt-36 md:pb-14 overflow-visible">
        <div className="container relative z-10 px-4">
          ...
          >
            {/* Trophy emblem - similar animation to creators but with unique flair */}
            <motion.div
              initial={{ scale: 0.7, opacity: 0, rotate: -15, y: 20 }}
              animate={{ scale: 1, opacity: 1, rotate: 0, y: 0 }}
              transition={{ duration: 0.8, delay: 0.2, ease: [0.34, 1.56, 0.64, 1], type: "spring", stiffness: 100 }}
            ...
            >
              ...
              {/* Clean emblem container with slight bounce */}
              <motion.div 
                className="relative p-3.5 sm:p-4 bg-gradient-to-br from-[#FFBB00] to-[#D4AF37] rounded-full shadow-lg"
                initial={{ scale: 0.8 }}
                animate={{ scale: 1 }}
