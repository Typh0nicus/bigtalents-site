    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-6 py-24">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <div className="relative">
              ...
              <div className="relative bg-black/40 border border-gold-vibrant/30 rounded-full p-8">
                <FiPackage className="w-16 h-16 text-gold-vibrant" />
              </div>
            </div>
          </motion.div>
          ...
          >
            {[
              { title: "Premium Quality", desc: "High-quality esports apparel" },
              { title: "Exclusive Designs", desc: "Limited edition collections" },
              { title: "Global Shipping", desc: "Worldwide delivery" }
            ].map((feature, i) => (
